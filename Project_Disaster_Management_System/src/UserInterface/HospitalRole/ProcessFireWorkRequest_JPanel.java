...
public class ProcessFireWorkRequest_JPanel extends javax.swing.JPanel {

    private JPanel userProcessContainer;
    private FireToHospitalRequest firerequest;
    private EnterpriseDirectory enterDir;
    
    public ProcessFireWorkRequest_JPanel(JPanel userProcessContainer, FireToHospitalRequest firerequest, EnterpriseDirectory enterDir) {
        initComponents();
    ...
    private void Submit_JButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Submit_JButtonActionPerformed
         if(Result_JTextField.getText().isEmpty()){
            ...
            firerequest.setAvailableNumberHospitalH(Result_JTextField.getText());
