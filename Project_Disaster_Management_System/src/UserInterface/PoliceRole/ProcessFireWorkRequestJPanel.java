...
public class ProcessFireWorkRequestJPanel extends javax.swing.JPanel {
    ...
    private FireToPoliceRequest firerequest;
    private EnterpriseDirectory enterDir;
    public ProcessFireWorkRequestJPanel(JPanel userProcessContainer, FireToPoliceRequest firerequest, EnterpriseDirectory enterDir) {
        initComponents();
    ...
    private void initComponents() {
        ...
        Result_JTextField.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                Result_JTextFieldKeyTyped(evt);
            }
        });
    ...
    private void Back_JButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Back_JButtonActionPerformed
        ...
        for(Component c:componentArray){
            if(c instanceof FireWorkAreaJPanel){
                FireWorkAreaJPanel mhtp= (FireWorkAreaJPanel) c;
                mhtp.populateFiretoPoliceTable();
                mhtp.populateRequestInfoTable();
                mhtp.populateFireRehabRequestTable();
                mhtp.populateFiretoHospitalTable();
    ...
    if(Result_JTextField.getText().isEmpty()){
            ...
            firerequest.setAvailableNumberHospitalF(Result_JTextField.getText());
            firerequest.setStatus("Completed");
    ...
    private void Result_JTextFieldKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_Result_JTextFieldKeyTyped
        // TODO add your handling code here:
        Submit_JButton.setEnabled(true);
    }//GEN-LAST:event_Result_JTextFieldKeyTyped
