...
public class MainJFrame extends javax.swing.JFrame {
    ...
    private ProductDirectory accDir;   //only a reference no memory allocated
    
    public MainJFrame() {
        initComponents();
        this.accDir = new ProductDirectory();     //memory allocated to the variable
    }
    ...
    private void btnProdManagerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProdManagerActionPerformed
        ...
        CardLayout cardlayout=(CardLayout)rightPanel.getLayout(); //typecasting
        rightPanel.add(amPanel);  //has one card laypout which will be visible also we have object of the second page which we will beusing to navigate to that page only
        cardlayout.next(rightPanel); //navigating to the second page
